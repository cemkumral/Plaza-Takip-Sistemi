 ...
 * @author TA
 */
public class arduino_tetikleme extends javax.swing.JFrame implements SerialPortEventListener {
    ...
    private void initComponents() {
        ...
        setTitle("Admin Alarm Paneli");

        jButton1.setText("Haberleşmeyi Başlat");
        ...
        jButton2.setText("Alarm Sistemini Çalıştır Ve LCD Uyarısı Yap");
        ...
        jLabel1.setText("ADMIN ALARM PANELI");

        jButton3.setText("Önceki Menüye Dön");
        ...
        jButton5.setText("Haberleşmeyi Durdur");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            ...
            Logger.getLogger(arduino_tetikleme.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(arduino_tetikleme.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
